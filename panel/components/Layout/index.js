  ...
  return (
    <div>
      <div className='flex h-screen bg-gray-200'>
        ...
        >
          <Menu.Brand>DevShop2</Menu.Brand>
          <Menu.Nav>
            ...
            <div className='flex items-center'>
              <div className='relative'>
                ...
                <div
                  ...
                  className={
                    'fixed inset-0 h-full w-full z-10 display: none' +
                    notificationOpen
                      ? 'block'
                      : ''
                  }
                ...
                {notificationOpen && (
                  <div className='absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl overflow-hidden z-10 width: 20rem; display: none'>
                    <a
                      href='#'
              ...
              <div className='relative'>
                <button
                  ...
                  className='relative h-8 w-8 rounded-full overflow-hidden shadow focus:outline-none'
                >
                  <img
                ...
                {dropdownOpen && (
                  <div
                    className={
                      'absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10 display: none'
                    }
                  >
                    <a
                      href='#'
